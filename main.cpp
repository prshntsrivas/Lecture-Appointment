...
//Appointment class from Student and Lecturer classes
...
{
	Student::setNumber(_temp[0]);
	Lecturer::setNumber(_temp[1]);
	setDate(_temp[2]);
	setStart(_temp[3]);
	setEnd(_temp[4]);
};
...
int main(int argc, char **argv)
{
	...
	char file1[] = "student.txt";
	char file2[] = "lecturer.txt";
	char file3[] = "appointment.txt";
	...
	while(menuLoop!=5)
	{
		...
		if(menuLoop==1)
		{
			...
			else if(menu==4)
			{
				...
				cout<<"Updated Student Graduation Year:"<<endl;
				cin>>temp_;
		...
		else if(menuLoop==3)
		{
			...
			if(menu==1)
			{
				...
				cout<<"Student No:"<<endl;
				cin>>temp_;
				newA.Student::setNumber(temp_);
				cout<<"Lecturer No:"<<endl;
				cin>>temp_;
				newA.Lecturer::setNumber(temp_);
			...
			else if(menu==3)
			{
				...
				while(i<z)
				{
					if(_A[i].Student::getNumber()==temp_ && _A[i].Lecturer::getNumber()==temp_2) deleted = i;
					i++;
				}
				for(i=deleted; i<z; i++)
				{
			...
			else if(menu==4)
			{
				...
				while(i<z)
				{
					if(_A[i].Student::getNumber()==temp_ && _A[i].Lecturer::getNumber()==temp_2) updated = i;
					i++;
				}
		...
		else if(menuLoop==4)
		{
			...
			for(i=0;i<z;i++)
			{
				writeToFile<<_A[i].Student::getNumber()<<" "<<_A[i].Lecturer::getNumber()<<" "<<_A[i].getDate()<<" "<<_A[i].getStart()<<" "<<_A[i].getEnd()<<endl;
			}
		}
		else if(menuLoop==5)
		{
